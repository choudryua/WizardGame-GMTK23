...
public class MovementController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        InputHandler.instance.OnJumpPressed += args => OnJumpInput();
        InputHandler.instance.OnJumpReleased += args => OnJumpUpInput();
    ...
    private void Update()
    {
        ...
        _moveInput.x = InputHandler.instance.MoveInput;
